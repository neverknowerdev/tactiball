...
CREATE INDEX idx_waiting_rooms_room_type ON waiting_rooms(room_type);

-- Add composite index for common queries
CREATE INDEX idx_waiting_rooms_type_status ON waiting_rooms(room_type, status, expires_at);
