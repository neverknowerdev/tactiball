...
-- Drop indexes
DROP INDEX IF EXISTS public.idx_waiting_rooms_lobby;
DROP INDEX IF EXISTS public.idx_waiting_rooms_expires_at;
DROP INDEX IF EXISTS public.idx_waiting_rooms_created_at;
DROP INDEX IF EXISTS public.idx_waiting_rooms_host_team;
