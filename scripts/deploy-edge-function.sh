...
echo "🚀 Deploying Supabase Edge Function: contract-events"
...
if [ ! -f "supabase/functions/contract-events/index.ts" ]; then
...
echo "   - ABLY_API_KEY (get from https://ably.com)"
...
echo ""
echo "🔌 Ably WebSocket Setup:"
echo "1. Create Ably account at https://ably.com"
echo "2. Create new app and copy API key"
echo "3. Set ABLY_API_KEY environment variable"
echo "4. Test WebSocket connections from client"
echo ""
echo "📚 For more information, see: supabase/functions/contract-events/README.md"
