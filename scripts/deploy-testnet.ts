...
const PUBLIC_KEY = "03a2c830194166c712d433b33607f69f7ac2c4e5b6fae20e4a159e204abc0ae5e0";
...
async function main() {
    ...
    if (hre.network.name !== "baseSepolia") {
        console.log("Not deploying to baseSepolia");
        return;
    }
    ...
    try {
        ...
        if (error.message.includes("Already Verified")) {
            ...
            console.log(`   npx hardhat verify --network baseSepolia ${currentImplAddress} --libraries GameLib:${gameLibAddress}`);
        }
    }
